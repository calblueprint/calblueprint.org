  ...
  task sync: :environment do
    ...
    db_apps.each do |app|
      app_params = {
        ...
        "[External Only] Background": app.response_to("sp24_external_experience_question"),

        "Time Commitment Acknowledgement": app.response_to("time_commitment_acknowledgement") && "Yes",
        
        "Mission First": app.response_to("sp24_mission_first"),
      ...
      if app.response_to("sp24_available_for_bp_games") == true
